...
// The pool is off unless GO_TOOLCHAIN_CACHE_LOOKAHEAD asks for it, and 0 turns
// it off rather than being raised to a floor. A positive count is honored up
// to maxLookAheadWorkers.
