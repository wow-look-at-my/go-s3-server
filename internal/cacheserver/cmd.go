...
// Main runs the server's command line. It is the whole exported surface of
// this package: everything else stays unexported, because the package holds
// one program rather than a library other code builds on.
func Main() {
